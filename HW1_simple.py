...
You are an experianced data analyst developer which extensive experience in pandas.
...
IN YOUR FUNCTION USE ONLT THE FOLLOWING COLUMNS:
flags, instruction, category, intent, response
...
The function should return a DataFrame, Series, or single value (str/int/float/bool).

The function should be named filter_dataset.
'''
...
class DatasetAgent:
    ...
    def generate_filter_function(self, user_question: str) -> str:
        ...
        try:
            ...
            validation_result = self.validate_filter_code(generated_code)
